  ...
  return (function(t) {
    ...
    function(t, e, r) {
      ...
      o(l.prototype),
        ...
        (l.prototype.open = l.prototype.connect =
          function() {
        ...
        (l.prototype.close = l.prototype.disconnect =
          function() {
            return (
              this.connected &&
      ...
      (function(e) {
        t.exports = function(t) {
          return (
            ...
            (n && (t instanceof e.ArrayBuffer || o(t)))
          );
        };
        var r =
          ...
          o =
          n && "function" == typeof e.ArrayBuffer.isView ?
    ...
    function(t, e) {
      (e.read = function(t, e, r, n, o) {
        var i,
          ...
          l = t[e + h];
        for (
          h += p, i = l & ((1 << -f) - 1), l >>= -f, f += a; f > 0; i = 256 * i + t[e + h], h += p, f -= 8
        );
        for (
          s = i & ((1 << -f) - 1), i >>= -f, f += n; f > 0; s = 256 * s + t[e + h], h += p, f -= 8
        );
        if (0 === i) i = 1 - c;
        else {
      ...
      (e.write = function(t, e, r, n, o, i) {
        ...
        for (
          ...
          ((s = Math.floor(Math.log(e) / Math.LN2)),
            ...
            ((a = e * Math.pow(2, h - 1) * Math.pow(2, o)), (s = 0))); o >= 8; t[r + l] = 255 & a, l += d, a /=
          256, o -= 8
        );
        for (
          s = (s << o) | a, c += o; c > 0; t[r + l] = 255 & s, l += d, s /= 256, c -= 8
        );
        t[r + l - d] |= 128 * y;
      });
    },
    function(t, e, r) {
      ...
      (e.fromByteArray = function(t) {
        for (
          var e, r = t.length, o = r % 3, i = [], s = 0, a = r - o; s < a; s += 16383
        )
    ...
    function(t, e, r) {
      ...
      (function(t) {
        ...
        function h(t, e) {
          if ((f(e), (t = a(t, e < 0 ? 0 : 0 | l(e))), !u.TYPED_ARRAY_SUPPORT))
        ...
        function E(t, e, r, n) {
          return F(
            (function(t, e) {
              for (
                var r, n, o, i = [], s = 0; s < t.length && !((e -= 2) < 0);
                ++s
              )
                (r = t.charCodeAt(s)),
                (n = r >> 8),
        ...
        u.TYPED_ARRAY_SUPPORT &&
          ...
          (u.compare = function(t, e) {
            ...
            if (t === e) return 0;
            for (
              var r = t.length, n = e.length, o = 0, i = Math.min(r, n); o < i;
              ++o
            )
              if (t[o] !== e[o]) {
                (r = t[o]), (n = e[o]);
      ...
      (function(e) {
        ...
        t.exports = function t(r) {
          ...
          if (
            ...
            return t(r.toJSON(), !0);
          for (var u in r)
            if (Object.prototype.hasOwnProperty.call(r, u) && t(r[u]))
              return !0;
          return !1;
        };
    ...
    function(t, e, r) {
      ...
      (t.exports = (function(t) {
        ...
        function(t, e, r) {
          (function(t) {
            ...
            (e.decodePayload = function(t, r, n) {
              ...
              var o;
              if (
                ("function" == typeof r && ((n = r), (r = null)), "" === t)
              )
                return n(d, 0, 1);
                ...
                function(t, e) {
                  ...
                  return (
                    e.forEach(function(t) {
                      ...
                      if (e) {
                        for (
                          var n = new Uint8Array(t.length), s = 0; s < t.length; s++
                        )
                          n[s] = t.charCodeAt(s);
                        r = n.buffer;
                      }
                      ...
                      for (s = 0; s < a.length; s++)
                        o[i++] = parseInt(a[s]);
                      for (
                        o[i++] = 255, n = new Uint8Array(r), s = 0; s < n.length; s++
                      )
                        o[i++] = n[s];
                    }),
                    r(o.buffer)
            ...
            (e.decodePayloadAsBinary = function(t, r, n) {
              ...
              for (var o = t, i = []; o.byteLength > 0;) {
                for (
                  var a = new Uint8Array(o), u = 0 === a[0], c = "", f = 1; 255 !== a[f]; f++
                ) {
        ...
        function(t, e) {
          ...
          (e.decode = function(t) {
            for (
              var e = {}, r = t.split("&"), n = 0, o = r.length; n < o; n++
            ) {
              var i = r[n].split("=");
              e[decodeURIComponent(i[0])] = decodeURIComponent(i[1]);
            }
        ...
        function(t, e) {
          ...
          (r.prototype.listeners = function(t) {
            return this._events && this._events[t] ?
              n(this._events[t]) ? [this._events[t]] :
        ...
        function(t, e, r) {
          ...
          class a extends n {
            ...
            send(t) {
              i("send data: ", t, this.readyState),
                this.readyState === a.OPEN && this._socket.send({
                  data: t
                });
            }
            close(t, e) {
              i("close socket: ", t, e),
                (this.readyState = a.CLOSING),
                this._socket.close({
                  code: t,
                  reason: e
                });
        ...
        function(t, e) {
          (e.read = function(t, e, r, n, o) {
            var i,
              ...
              l = t[e + h];
            for (
              h += p, i = l & ((1 << -f) - 1), l >>= -f, f += a; f > 0; i = 256 * i + t[e + h], h += p, f -=
              8
            );
            for (
              s = i & ((1 << -f) - 1), i >>= -f, f += n; f > 0; s = 256 * s + t[e + h], h += p, f -= 8
        ...
        function(t, e, r) {
          ...
          (function(t) {
            ...
            (u.prototype.readUInt16LE = function(t, e) {
              return (
                e || x(t, 2, this.length), this[t] | (this[t + 1] << 8)
              );
            }),
            (u.prototype.readUInt16BE = function(t, e) {
              return (
                e || x(t, 2, this.length), (this[t] << 8) | this[t + 1]
              );
            }),
            (u.prototype.readUInt32LE = function(t, e) {
              return (
            ...
            (u.prototype.readIntBE = function(t, e, r) {
              (t |= 0), (e |= 0), r || x(t, e, this.length);
              for (
                var n = e, o = 1, i = this[t + --n]; n > 0 && (o *= 256);
            ...
            function F(t, e, r, n) {
              for (
                var o = 0; o < n && !(o + r >= e.length || o >= t.length);
                ++o
              )
                e[o + r] = t[o];
              return o;
            ...
            h || "undefined" != typeof window || (h = n),
              ...
              (p.prototype.write = function(t) {
                ...
                for (var r, n = t.length, o = 0, s = n; o < s; o++)
                  (r = t[o]),
                  i.encodePacket(r, e.supportsBinary, function(t) {
                    try {
                      e.ws.send(t);
                    } catch (t) {}
                    --n ||
        ...
        function(t, e, r) {
          (function(e) {
            ...
            o(f.prototype),
              ...
              (f.prototype.write = f.prototype.send =
                function(t, e, r) {
    ...
    function(t, e, r) {
      ...
      function u(t, e) {
        ...
        return (
          ...
          (s("ignoring socket cache for %s", u), (r = i(u, e))) :
          (a[c] || (s("new io instance for %s", u), (a[c] = i(u, e))),
            (r = a[c])),
